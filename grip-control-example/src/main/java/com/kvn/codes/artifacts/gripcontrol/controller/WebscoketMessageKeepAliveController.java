...
@RequestMapping("/ka")
@Slf4j
public class WebscoketMessageKeepAliveController {
...
//            channelMap.put("channel", channel + "#" + UUID.randomUUID().toString());
            ...
            Map<String, Object> keepAliveMap = new HashMap<String, Object>();
            keepAliveMap.put("timeout", 30);
            keepAliveMap.put("content", "ka");
            keepAliveMap.put("message-type", "ping");
            keepAliveMap.put("mode", "interval");
            outEvents.add(new WebSocketEvent("TEXT",
                    "c:" + GripControl.webSocketControlMessage("keep-alive", keepAliveMap)));
